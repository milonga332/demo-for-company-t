...
/*
 ...
 For production, I'd prefer to implement it with "State Pattern", which means all the states will be separated into several different classes for better maintainability. (like ScanningState, ConnectingState, and ...etc)
 */
